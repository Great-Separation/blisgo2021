                        ...
                        <form action="/register">
                            <div class="card">
                                ...
                                <div class="card-footer text-center">
                                    <p class="mb-0">Already have an account?<a id="login-link" class="ps-2 text-decoration-none" href="/login">Log In!</a></p>
                                </div>
                            </div>
                        </form>
                    </div>
