<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <footer class="d-none d-lg-block p-3" id="footer">
        <section>
            <div class="row">
            ...
            <div class="row text-center p-2">
                <div class="col align-self-center"><a class="p-2 text-secondary text-decoration-none" href="/faq">FAQ</a><a class="p-2 text-secondary text-decoration-none" href="/introduce">프로젝트 소개</a>
