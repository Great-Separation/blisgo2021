...
<!DOCTYPE html>
<html lang="ko" style="height: 100vh;" oncontextmenu="return false"
...
<body>
	<header id="header">
		<div
			class="container-fluid d-flex justify-content-center align-items-center d-flex align-items-center"
			id="highlight-index">
			<article>
				<form action="/loginPOST" method="post">
					<div class="card">
						...
						<div class="card-body pb-0">
							<input class="form-control email-imput form-control mt-2"
								type="email" required="" placeholder="이메일" minlength="6"
								name="email"><input
								class="form-control password-input form-control mt-2"
								type="password" required="" placeholder="비밀번호" minlength="6"
								name="pass">
							<button class="btn btn-success box-shadow w-100 mt-2 mb-2"
								type="submit">로그인</button>
							<c:choose>
								<c:when test="${passCheck==null}"></c:when>
								<c:otherwise>
									<div class="alert alert-danger pt-2 pb-2 mb-0 text-center"
										role="alert">
										<span><i class="fas fa-exclamation-triangle"></i><strong>로그인
												실패.</strong> 비밀번호 불일치</span>
									</div>
								</c:otherwise>
							</c:choose>
						</div>
							...
							<div class="row d-xxl-flex align-items-xxl-center">
								<div class="col">
									<div class="form-check d-xxl-flex align-items-xxl-center"
										id="form-check-signs-of-agreement-1">
										<input class="form-check-input" type="checkbox"
											id="formCheck-remember-1" for="remember" name="check"><label
											class="form-check-label" for="formCheck"><span
											class="label-text">로그인 유지</span></label>
									</div>
								</div>
								<div class="col">
									<a class="float-end text-decoration-none"
										id="forgot-password-link-1" href="/verify">비밀번호 찾기</a>
								</div>
							</div>
						</div>
						<div class="card-footer text-center">
							<p class="m-0">
								계정이 없으신가요?<a id="register-link-1"
									class="text-decoration-none ps-2" href="/register">회원가입</a>
							</p>
						</div>
					</div>
				</form>
