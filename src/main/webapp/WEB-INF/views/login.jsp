            ...
            <div class="container"><a class="navbar-brand logo" id="navbar-brand" href="/">분리수GO!</a><button data-bs-toggle="collapse" class="navbar-toggler collapsed mr-auto p-0" data-bs-target="#navbar-collapse" id="navbar-toggle"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbar-collapse">
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item" id="login-1"><a class="nav-link" data-bs-toggle="tooltip" data-bss-tooltip="" data-bs-placement="bottom" href="/login" title="회원이용시 다양한 혜택을 이용할 수 있습니다">로그인</a></li>
                    </ul>
                    ...
                    <form>
                        <div class="card">
                            ...
                            <div class="card-body pb-0"><input class="form-control email-imput form-control mt-2" type="email" required="" placeholder="이메일" minlength="6"><input class="form-control password-input form-control mt-2" type="password" required="" placeholder="비밀번호" minlength="6"><button class="btn btn-success box-shadow w-100 mt-2 mb-2" type="submit">로그인</button>
                                <div class="alert alert-danger pt-2 pb-2 mb-0 text-center" role="alert"><span><i class="fas fa-exclamation-triangle"></i><strong>로그인 실패.</strong> 비밀번호 불일치</span></div>
                            </div>
                            <div class="card-body">
                                <div class="btn-group-vertical d-flex flex-fill" role="group"><button class="btn w-100 mb-2 p-0" type="button"><html>
<head>
...
<body>
  ...
  <script src="https://apis.google.com/js/platform.js?onload=renderButton" async defer></script>
                                ...
                                <div class="row d-xxl-flex align-items-xxl-center">
                                    <div class="col">
                                        <div class="form-check d-xxl-flex align-items-xxl-center" id="form-check-signs-of-agreement"><input class="form-check-input" type="checkbox" id="formCheck-remember" for="remember" name="check"><label class="form-check-label" for="formCheck"><span class="label-text">로그인 유지</span></label></div>
                                    </div>
                                    <div class="col"><a class="float-end text-decoration-none" id="forgot-password-link" href="/verify">비밀번호 찾기</a></div>
                                </div>
                            </div>
                            <div class="card-footer text-center">
                                <p class="m-0">계정이 없으신가요?<a id="register-link" class="text-decoration-none ps-2" href="/register">회원가입</a></p>
                            </div>
                        </div>
                    </form>
                </article>
