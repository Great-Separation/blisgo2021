                ...
                <form method="post" action="/write_post">
                    <div class="card shadow">
                        <div class="card-header">
                            <div class="row">
                                <div class="col p-0">
                                    <div class="input-group"><input class="form-control" type="text" placeholder="제목" name="write-title"><span class="input-group-text">${writer_nick}<br></span></div>
                                </div>
                            </div>
                        </div>
                        <div class="card-body p-0"><textarea class="form-control" id="txtTinyMCE" name="write-content"></textarea></div>
